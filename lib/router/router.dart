...
final GoRouter newRouter = GoRouter(
  ...
  routes: <RouteBase>[
    ...
    GoRoute(
      ...
      builder: (BuildContext context, GoRouterState state) {
        final EnumMateriState pageState =
            state.extra as EnumMateriState? ?? EnumMateriState.mengenalPosisi;
        // state.extra as EnumMateriState? ?? EnumMateriState.ayoBelajar;
    ...
    GoRoute(
      path: RouterUtils.credit,
      builder: (BuildContext context, GoRouterState state) {
        return const CreditView();
      },
    ),
    GoRoute(
      path: RouterUtils.panduan,
      builder: (BuildContext context, GoRouterState state) {
        return const PanduanView();
      },
    ),
  ],
);
